/**
 * Purpose: Generate and parse a unique actor roster.
 * Pattern: Simple Module.
 * Usage: Imported by the owning workflow.
 * Related: src/backend/core/simulation/roles/generator/prompts/roster.ts
 */
import { renderRosterPrompt } from "./prompts/roster"
