...
def build_time_advanced_event(
    *,
    ...
    return {
        "event": "time_advanced",
        "event_key": f"time_advanced:{round_index}",
        "run_id": run_id,
        "round_index": round_index,
...
def build_llm_call_event(
    *,
    ...
    return {
        ...
        "semantic_coercion_reasons": list(semantic_coercion_reasons or []),
