...
LLM_CALL_COLUMN_LABELS = {
    ...
    "total_tokens": "총 토큰",
    "parse_failure_count": "파싱 실패 수",
    "forced_default": "기본값 강등 여부",
    "fixer_used": "fixer 사용 여부",
    "provider_structured_mode": "구조화 모드",
    "prompt_variant": "프롬프트 변형",
    "semantic_coercion_used": "의미 보정 사용 여부",
    "semantic_coercion_reasons": "의미 보정 사유",
    "post_coercion_valid": "보정 후 유효 여부",
    "retry_stage": "재시도 단계",
    "retry_route": "재시도 경로",
    "retry_attempt": "재시도 순번",
    "retry_budget": "재시도 예산",
    "retry_reason": "재시도 사유",
    "missing_field_paths": "누락 필드 경로",
    "log_context": "로그 컨텍스트",
    "prompt": "프롬프트",
    "raw_response": "원본 응답",
}
...
NETWORK_GROWTH_COLUMN_LABELS = {
    ...
    "density": "실제 연결 비율",
    "average_path_depth": "평균 경로 깊이",
    "edge_growth_rate": "엣지 성장률",
    "active_actor_growth_rate": "활성 행위자 성장률",
    "top20_interaction_share": "상위 20% 행위자 점유율",
