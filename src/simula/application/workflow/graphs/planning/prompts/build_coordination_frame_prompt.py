...
# Goal
Generate only the coordination frame that will guide runtime focus decisions.

# Rules
- Every field is required.
- Keep each rule concrete and scenario-grounded.
- `focus_selection_rules`, `background_motion_rules`, `focus_archetypes`, `attention_shift_rules`, and `budget_guidance` must stay non-empty arrays.
