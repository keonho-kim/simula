...
def build_major_event_update_batch_prompt_bundle(
    *,
    ...
    return build_json_prompt_bundle(
        example=_MAJOR_EVENT_UPDATE_BATCH_EXAMPLE,
        example_mode=example_mode,
    )
...
def build_actor_intent_state_batch_prompt_bundle(
    *,
    ...
    return build_json_prompt_bundle(
        example=_ACTOR_INTENT_STATE_BATCH_EXAMPLE,
        example_mode=example_mode,
    )
...
_MAJOR_EVENT_UPDATE_BATCH_EXAMPLE: dict[str, Any] = {
    "event_updates": [
        {
            "event_id": "<major event id>",
            "status": "<choose one of pending, in_progress, completed, missed>",
...
_ACTOR_INTENT_STATE_BATCH_EXAMPLE: dict[str, Any] = {
    "actor_intent_states": [
        {
            "cast_id": "<cast_id>",
            "current_intent": "<one Korean sentence describing the current intent>",
